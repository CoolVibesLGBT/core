...
var repositoryMethodCoverage = map[string]string{
	"ChatRepository": strings.Join([]string{
		...
		"DeleteMessage", "DeleteMessageForAll", "DeleteMessageForUser", "GetChatByID", "GetChatByIDWithoutRelations",
	...
	"EngagementRepository": strings.Join([]string{
		...
		"RemoveEngagementDetail", "ToggleEngagement",
	}, " "),
	...
	"PostRepository": strings.Join([]string{
		...
		"GetUserPostReplies", "GetUserPosts", "Like", "Node", "PillarExistsBySlug", "Report", "SendNotification",
	...
	"UserRepository": strings.Join([]string{
		...
		"GetUsersStartingWith", "Login", "LoginViaToken", "Node", "TestUser", "UpdateLocation", "UpdateUser",
