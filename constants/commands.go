...
const (
	...
	CMD_CHAT_MESSAGE_OPEN           = "chat.message.open"
	CMD_CHAT_MESSAGE_OPENED         = "chat.message_opened"
	CMD_CHAT_MESSAGE_EXPIRED        = "chat.message_expired"
	...
	CMD_USER_PRIVATE_PHOTOS_ACCESS_REVOKE   = "user.private_photos.access.revoke"
	...
	CMD_USER_VIEW_PROFILE      = "user.view_profile"
	...
	CMD_POST_EVENT_RSVP = "post.event_rsvp"
	...
	CMD_SEARCH_GLOBAL      = "search.global"
